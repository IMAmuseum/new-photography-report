...
java -jar C:\saxon\saxon9he.jar -s:XML\SURL.xml -xsl:XSLT\NewPhotography_SURLtransform.xsl -o:CMD\PictionCall.cmd
...
java -jar C:\saxon\saxon9he.jar -s:CurrentReport\NewPhotographyOutput_%Date%.xml -xsl:XSLT\NewPhotography_HTMLtransform.xsl -o:CurrentReport\NewPhotographyReport_%Date%.html
...
java -jar C:\saxon\saxon9he.jar -s:CurrentReport\NewPhotographyOutput_%Date%.xml -xsl:XSLT\NewPhotography_IRNlistTransform.xsl -o:CurrentReport\NewPhotography_IRNs_%Date%.csv
...
java -jar C:\saxon\saxon9he.jar -s:CurrentReport\NewPhotographyOutput_%Date%.xml -xsl:XSLT\NewPhotography_KeywordTransform.xsl -o:CurrentReport\NewPhotography_Keywords_%Date%.txt
...
java -jar C:\saxon\saxon9he.jar -s:CurrentReport\NewPhotographyOutput_%Date%.xml -xsl:XSLT\NewPhotography_ImageURLtransform.xsl -o:CMD\DownloadImages.cmd
